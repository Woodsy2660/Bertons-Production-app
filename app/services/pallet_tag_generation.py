...
def generate_pallet_tag_pdf(
    ...
    *,
    ...
    html = template.render(tags=tags, tags_per_sheet=tags_per_sheet)
    ...
    .tag-title { font-size: 16pt; font-weight: bold; text-align: center; margin-bottom: 18px; }
    ...
    """
    return _render_html_to_pdf(html, css)