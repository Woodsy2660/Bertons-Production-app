...
CASK_PRODUCTION_WASTE_TEMPLATE = FormTemplate(
    ...
    header_fields=[
        ...
        FieldDef(key="casks_other_count", label="Casks — Other (count)", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        FieldDef(key="casks_other_problem", label="Casks — Other (problem)", field_type=FieldType.TEXT, source=FieldSource.OPERATOR),
        FieldDef(key="casks_total", label="Casks — Total", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        # Bladders
        ...
        FieldDef(key="bladders_other_count", label="Bladders — Other (count)", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        FieldDef(key="bladders_other_problem", label="Bladders — Other (problem)", field_type=FieldType.TEXT, source=FieldSource.OPERATOR),
        FieldDef(key="bladders_total", label="Bladders — Total", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        # Inners
        ...
        FieldDef(key="inners_other_count", label="Inners — Other (count)", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        FieldDef(key="inners_other_problem", label="Inners — Other (problem)", field_type=FieldType.TEXT, source=FieldSource.OPERATOR),
        FieldDef(key="inners_total", label="Inners — Total", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        # Outers
        ...
        FieldDef(key="outers_other_count", label="Outers — Other (count)", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
        FieldDef(key="outers_other_problem", label="Outers — Other (problem)", field_type=FieldType.TEXT, source=FieldSource.OPERATOR),
        FieldDef(key="outers_total", label="Outers — Total", field_type=FieldType.NUMBER, source=FieldSource.OPERATOR),
